...
[![Release](https://img.shields.io/github/v/release/edouardbruelhart/Manexp-Web-Lists)](https://img.shields.io/github/v/release/edouardbruelhart/Manexp-Web-Lists)
...
A repository to fetch and host lists for Manexp-Web project, notably the species and pesticides lists.
...
git remote add origin git@github.com:edouardbruelhart/Manexp-Web-Lists.git
